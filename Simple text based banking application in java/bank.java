	...
	public static void main(String[] args) {
		...
		while(sentinal != -1){
			...
			if(userInput == 1){
				...
				System.out.println("This customer has rupees " + balence + " in their account");
			}
			else if(userInput == 4){
				...
				for(int i = 0; i < size; i++){
					...
					System.out.println(accountNames[i] + " has rupees 1" + accountBalences[i] + " in their account");
				}
				System.out.println("In total, there is rupees" + total + " in the bank");
			}
			else if(userInput == -1){
				System.exit(-1);
			}
